...
$tables=['media_workers','media_job_events','channel_stats','channel_posts','invite_link_events','media_jobs','media_batches','orders','products','settings'];
...
$migration=new ReflectionMethod(App::class,'ensureMediaSchema');
$migration->setAccessible(true);
$migration->invoke(null,$pdo);
