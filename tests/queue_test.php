...
$pdo->exec("ALTER TABLE media_batches ADD COLUMN sequential_mode tinyint(1) NOT NULL DEFAULT 0,ADD COLUMN pipeline_depth tinyint unsigned NOT NULL DEFAULT 1,ADD COLUMN distribution_mode varchar(20) NOT NULL DEFAULT 'single',ADD COLUMN destination_channels_json longtext NULL,ADD COLUMN destination_limit int unsigned NOT NULL DEFAULT 0,ADD COLUMN overflow_items int unsigned NOT NULL DEFAULT 0");
